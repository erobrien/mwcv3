...
const ITEMS = [
  "Weight gain", "Breast tissue development", "Currently using Viagra or Cialis",
  "Unable to lose weight", "Decreased strength", "Decreased endurance",
  "Slower recovery from workouts", "Plateaued or going backwards in the gym",
  "Poor sleep", "Fatigue",
];
...
const Step13 = ({ onNext }: StepProps) => {
  ...
  return (
    <StepCard h1="SYMPTOMS">
      <h2 className="intake-h2 mb-2">Physical — check anything you've noticed</h2>

...
const V2StepCalendar = ({ firstName, phone, email, locationLabel, onNext }: V2StepCalendarProps) => {
  ...
  return (
    <div className="flex flex-col items-center px-5 py-4 md:py-8">
      ...
      <p className="mb-4 text-center" style={{ fontFamily: font, fontSize: 14, color: "#B0ADA8" }}>
      ...
      >
        ...
        <div className="mb-6">
          <label
            ...
            style={{ fontFamily: font, fontWeight: 600, fontSize: 11, color: "#9CA3AF", letterSpacing: "0.08em" }}
          >
            Available Times
          </label>
          {!selectedDay ? (
              ...
              {timeSlots.map((t) => (
                <button
                  ...
                  style={{
                    ...
                    color: selectedTime === t ? "#fff" : "#B0ADA8",
                    cursor: "pointer",
        ...
        <div className="mb-6 flex items-start gap-2">
          ...
          <div>
            <label htmlFor="sms-reminder-v2" style={{ fontFamily: font, fontSize: 13, color: "#B0ADA8" }}>Send me appointment reminders via text</label>

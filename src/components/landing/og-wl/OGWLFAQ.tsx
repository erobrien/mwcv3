...
export const OGWLFAQ = () => (
  <UnifiedFAQ
    ...
    faqs={[
      ...
      { question: "What does it cost?", answer: "Your initial consultation and evaluation are completely free. Treatment plans are transparent with no hidden fees. FSA/HSA accepted." },

...
export const TRT2FAQ = () => (
  <UnifiedFAQ
    ...
    faqs={[
      ...
      { question: "What does it cost?", answer: "Your initial testosterone testing is completely free. Treatment pricing is transparent with no hidden fees. We'll walk you through everything at your first visit." },

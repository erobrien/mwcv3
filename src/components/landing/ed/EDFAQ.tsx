...
export const EDFAQ = () => (
  <UnifiedFAQ
    ...
    faqs={[
      ...
      { question: "What does it cost?", answer: "Your initial consultation is completely free. Treatment pricing is transparent with no hidden fees. We accept FSA/HSA. We'll walk you through everything at your first visit." },

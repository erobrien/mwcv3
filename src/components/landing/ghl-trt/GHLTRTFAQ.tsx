...
const faqs = [
  { question: "How much does TRT cost?", answer: "We'll give you a clear breakdown during your free consultation — no hidden fees. Treatment plans start at $199/month after approval." },

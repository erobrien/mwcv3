...
const faqs = [
  ...
  { question: "What happens at my first visit?", answer: "Your first visit takes about 60 to 90 minutes. You'll meet face-to-face with a board-certified physician, have comprehensive blood work drawn in our CLIA-certified lab with same-day results, and discuss your symptoms and health goals. If treatment is appropriate, you can start the same day. There's no obligation to start treatment, the consultation is free." },
  { question: "Do I need a referral?", answer: "No. Men's Wellness Centers is a direct-access center. You can book your free consultation without a referral from another physician. Simply schedule online or call any of our three Virginia locations." },
  ...
  { question: "How is Men's Wellness Centers different from online TRT providers?", answer: "We see you in person at every visit. We draw blood on-site with same-day results (not mail-in kits), perform physical examinations, and your physician adjusts your protocol based on your labs and how you feel. We also treat ED, weight loss, and peptides under one roof." },
  ...
  { question: "Am I a candidate for treatment?", answer: "Most men over 30 experiencing fatigue, weight gain, low libido, or brain fog are candidates. Book a free consultation and we will run comprehensive labs on-site with same-day results." },

    ...
    <section style={{ background: "#EBEAE8", padding: "80px 0" }}>
      <div className="max-w-6xl mx-auto px-4 md:px-6">
        ...
        <p className="first-visit-answer-block text-[13px] md:text-sm leading-relaxed max-w-3xl mb-8 md:mb-12" style={{ color: "#666", fontStyle: "italic" }}>
          Your first visit to Men's Wellness Centers takes 60-90 minutes. You meet with a board-certified physician, receive comprehensive blood work with results reviewed in-visit from our CLIA-certified lab, and can start treatment the same day. No referral needed. Free consultation. Located at {location.address}, {location.cityStateZip}.
        </p>
